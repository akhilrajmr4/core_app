# Generated by Django 3.0.14 on 2022-02-17 21:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=100)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='projectbranch', to='base_app.branch_registration')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='projectdepartment', to='base_app.branch_registration')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='project_taskassignproject', to='base_app.project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternativeno', models.IntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='trainer_tasktrainer', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='topic',
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='topicteam', to='base_app.create_team')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='topictrainer', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='tester_status',
            fields=[
                ...
                ('progress', models.IntegerField()),
                ('status', models.CharField(max_length=200)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='tester_statusproject', to='base_app.project')),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='tester_statustask', to='base_app.project_taskassign')),
                ('tester', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='tester_statustester', to='base_app.user_registration')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='tester_statususer', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='test_status',
            fields=[
                ...
                ('workdone', models.TextField()),
                ('files', models.FileField(default='', upload_to='')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='test_statusproject', to='base_app.project')),
                ('taskname', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='test_statustaskname', to='base_app.user_registration')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='test_statususer', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='reported_issue',
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('reported_to', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reported_issuereported_to', to='base_app.user_registration')),
                ('reporter', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reported_issuereporter', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='qualification',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='qualificationuser', to='base_app.user_registration')),
            ],
        ),
        migrations.AddField(
            model_name='project_taskassign',
            name='tl',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='project_taskassigntl', to='base_app.user_registration'),
        ),
        migrations.AddField(
            model_name='project_taskassign',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='project_taskassignuser', to='base_app.user_registration'),
        ),
        migrations.AddField(
            model_name='project',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='projectuser', to='base_app.user_registration'),
        ),
        migrations.CreateModel(
            name='leave',
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='leaveuser', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projecturl', models.CharField(blank=True, default='', max_length=100, null=True)),
                ...
                ('status', models.CharField(default='', max_length=100)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='extracurricularuser', to='base_app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='designation',
            fields=[
                ...
                ('status', models.CharField(max_length=100)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='designationbranch', to='base_app.branch_registration')),
            ],
        ),
        migrations.CreateModel(
            name='department',
            fields=[
                ...
                ('status', models.CharField(max_length=100)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='departmentbranch', to='base_app.branch_registration')),
            ],
        ),
        migrations.CreateModel(
            name='attendance',
            fields=[
                ...
                ('date', models.DateField(max_length=100)),
                ('status', models.CharField(max_length=200)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='attendanceuser', to='base_app.user_registration')),
            ],
        ),
    ]
